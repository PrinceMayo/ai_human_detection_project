...
def load_models():
    tfidf = joblib.load("/workspaces/ai_human_detection_project/models/tfidf_vectorizer.pkl")
    svm = joblib.load("/workspaces/ai_human_detection_project/models/svm_model.pkl")
    tree = joblib.load("/workspaces/ai_human_detection_project/models/decision_tree_model.pkl")
    ada = joblib.load("/workspaces/ai_human_detection_project/models/adaboost_model.pkl")
